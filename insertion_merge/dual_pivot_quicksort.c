...
void dualPivotPartition(uint64_t arr[], int64_t low, int64_t high, int64_t* pivot1, int64_t* pivot2) {
...
void dualPivotQuickSort(uint64_t arr[], int64_t low, int64_t high) {
    if (low < high) {
        int64_t pivot1, pivot2;
